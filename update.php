...
<br><br>
   ...
   <a class="btn btn-primary py-2 mb-2" href="panel_novedades.php">AGREGAR NUEVO</a>
 ...
 <tbody>
    <tr>
      ...
      <td><?php echo $consult['titulo']; ?></td>
      <td><?php echo $consult['subtitulo']; ?></td>
      <td><?php echo $consult['fecha']; ?></td>
      <td><a href="editar.php?id=<?php echo $consult['id']; ?>" class="btn btn-success">Editar</a></td>
      <td><a onclick="return borrar();" href="borrar.php?id=<?php echo $consult['id']; ?>" class="btn btn-danger">Borrar</a></td>
    </tr>
