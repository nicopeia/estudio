...
<section id="fondoServimp">
  <div class="overlayservimp">
  <div class="container">
  <div class="row">
    ...
    <div class="col-md-6 contenidoserv mt-5 py-5">
      ...
      <br><br>
              ...
              <h1 style="color:#fdfdfd" class=" display-2   text-left ">IMPUESTOS</h1>
              <p class="text-white lead mb-5">Nuestros servicios, prestados con la intervención directa de los Socios y la colaboración de personal especializado, ponen foco en la planificación impositiva y el análisis detallado de las actividades económicas de la empresa.</p>
...
<div id="datos" class="container">
   ...
   <div class="row">
   <div class="col-md-8 py-3 text-black puntosInfo">
...
<hr style="color: black;">
   ...
   <div class="col-md-4 py-3 text-white mt-5">
