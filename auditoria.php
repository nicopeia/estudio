...
<nav  class="navbar navbar-expand-lg bg-white fixed-top">
    ...
    <div  class="collapse navbar-collapse" id="navbarCollapse">
      ...
      <ul  class="navbar-nav ml-auto">
        ...
        <li  class="nav-item mr-3">
          <a class="nav-link" href="industrias.php">INDUSTRIAS</a>
          <div class="line"></div>
        </li>
...
<section id="fondoServiciosau">
  <div class="overlayservau">
  <div class="container">
  <div class="row">

    <div class="col-md-6 contenidoserv mt-5 py-5">
...
<br><br>
        ...
        <h4 style="color:#6ea4ee; font-weight: 600;" class="    text-left lead">Servicios</h4>
        <h1 style="color:#fdfdfd" class=" display-2   text-left ">AUDITORÍA</h1>
        <p class="text-white lead mb-5">Nuestro enfoque de auditoría, basado en el entendimiento del negocio, está orientado a aportar soluciones de valor.Validación y correcta valuacion de la informacion y saldos contables de acuerdo a normas profesionales argentinas.</p>
...
<div id="datos" class="container">
   ...
   <div class="row">
   <div class="col-md-12 py-5 text-black puntosInfo">


    
    <hr style="color: black;">
    <p>Prestamos los siguientes servicios:</p>
    <hr style="color: black;">
    ...
    <ul style="color:#2379EE">



      <li>Asesoramiento impositivo y previsional</li>
         <li>Análisis del impacto fiscal sobre nuevos negocios e inversiones nacionales e internacionales </li>
            <li>Planificación fiscal </li>
                  <li>Due Diligence impositivo y previsional</li>
                  <li>Estudios de precios de transferencia y defensa por ajustes</li>
                     <li>Formulación de consultas vinculantes</li>
                     <li>Interposición de recursos por ajustes practicados por organismos de control fiscal</li>
                     <li>Atención de inspecciones de los organismos fiscales (nacionales, provinciales y municipales)</li>
...
<h6 style="color:#2379EE">AUDITORÍA BANCOS Y SERVICIOS FINANCIEROS</h6>
<h1>BANCOS Y SERVICIOS FINANCIEROS</h1>
<p>La industria financiera se caracteriza por su alto nivel de competencia, permanentes cambios regulatorios y una fuerte exposición a riesgos.

  Contamos con un equipo que abarca soluciones integrales para dar respuesta a las necesidades del mercado.</p>
...
<div class="bg-white  py-4">
   ...
   <div class="col-md-12 text-center plantilla">
   
       <ul>


     <li>   <p>Auditoria interna y operativa</p></li>
     <li>   <p>Informes especiales y revisiones</p></li>
