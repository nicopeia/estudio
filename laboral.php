...
<section id="fondoServlab">
  <div class="overlayservlab">
  <div class="container">
  <div class="row">
    ...
    <div class="col-md-6 contenidoserv mt-5 py-5">
      ...
      <br><br>
              ...
              <h1 style="color:#fdfdfd" class=" display-2   text-left ">LABORAL</h1>
              <p class="text-white lead mb-5">Asesoramiento y evaluación de formas de contratación, liquidación de sueldos y jornales mensuales.</p>
...
<hr style="color: black;">
   ...
   <ul style="color:#2379EE">
     ...
     <li>Liquidación de Sueldos y jornales y registración</li>
        <li>Atención inspecciones previsionales</li>
           <li>Rúbrica de libros laborales </li>
                 <li>Asesoramiento en Ley Penal Previsional</li>
                 <li>Informes y Análisis de Gestión</li>
